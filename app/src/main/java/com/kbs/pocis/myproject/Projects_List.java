...
public class Projects_List extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        title_text = view.findViewById(R.id.title_project);
        recyclerView = view.findViewById(R.id.list_project_open);
        setTitle();
        return view;
    }
    public void setTitle(){
        //todo ini null mulu title_text nya
//        switch (list_status) {
//            case 0:
//                title_text.setText("Showing all list of open projects. Tap to see details.");
//                break;
//            case 1:
//                title_text.setText("Showing all list of closed projects. Tap to see details.");
//                break;
//            case 2:
...
//        }
    ...
    public void RefreshData(ArrayList<Model_Project> model_project_s){
        Log.i("project_list",list_status+" size="+model_project_s.size());
        //todo tampilin modelnya error
